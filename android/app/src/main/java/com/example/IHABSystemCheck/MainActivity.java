...
import com.example.IHABSystemCheck.bluetoothspp.library.BluetoothSPP;
import com.example.IHABSystemCheck.bluetoothspp.library.BluetoothState;
import com.example.IHABSystemCheck.bluetoothspp.library.DeviceList;
...
public class MainActivity extends AppCompatActivity {
    ...
    public double[] obtainCalibration() {
        ...
        File dir = new File(Environment.getExternalStorageDirectory() + File.separator + "IHAB" + File.separator + "calibration");
        ...
        public void run() {
            switch (myState) {
                ...
                case WAITING_IN__RFCOMM:
                    ...
                    mSymbol.setImageResource(R.drawable.hourglass_snooze);
                    if (((Switch) findViewById(R.id.protocolSwitch)).isChecked())
                        myState = state.CHAINGING_TO_PHANTOM;
                    setMessageDump("Preparing");
                    break;
                case CHAINGING_TO_PHANTOM:
                    mSymbol.setImageResource(R.drawable.hourglass_snooze);
                    initBluetooth();
                ...
                case WAITING_FOR_MEASURING:
                    if (((Switch) findViewById(R.id.protocolSwitch)).isChecked()) {
                        setMessageDump("Waiting;DEVCIE=" + bt.getConnectedDeviceAddress() + ";");
                    }
                    else {
        ...
        findViewById(R.id.btnLinkDevice).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (intentSelectDevice == null) {
                    intentSelectDevice = new Intent(getApplicationContext(), DeviceList.class);
                    startActivityForResult(intentSelectDevice, BluetoothState.REQUEST_CONNECT_DEVICE);
                }
            }
        });
        ...
        if (bt.isBluetoothEnabled() == true) {
            bt.setBluetoothStateListener(new BluetoothSPP.BluetoothStateListener() {
                public void onServiceStateChanged(int state) {
                    ...
                    if (state == BluetoothState.STATE_CONNECTED && bt != null) {
